...
our %return_counts = (
        'enumerate_user_sets' => 1,
        'enumerate_system_sets' => 1,
        'set_get' => 1,
        'set_create' => 1,
        'set_delete' => 0,
        'set_add_genome' => 0,
...
{
    my ($self) = @_;
    my $submod = $self->get_service_name() || 'GenomeSet';
    my $loggers = {};
...
sub call_method {
    ...
    my $ctx = GenomeSetServerContext->new($self->{loggers}->{userlog},
    ...
    # Service GenomeSet does not require authentication.
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service GenomeSet.");
    }
...
package GenomeSetServerContext;

use strict;

=head1 NAME

GenomeSetServerContext
