...
sub load_from_fh
{
	...
	my $text = <$fh>;
	#
	# This is a hack. It should be fixed on web-form input.
	# However, it allows the jobs to run and display.
	#
	my $utext = encode('UTF-8', $text);
	$dom = $parser->parse_string($utext);
    }
