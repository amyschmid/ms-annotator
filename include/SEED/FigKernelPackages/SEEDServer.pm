...
our %return_counts = (
        'compare_regions' => 1,
        'compare_regions_for_peg' => 1,
        'get_ncbi_cdd_url' => 1,
        'compute_cdd_for_row' => 1,
        'compute_cdd_for_feature' => 1,
        'get_palette' => 1,
        'get_function' => 1,
        'assign_function' => 1,
        'get_location' => 1,
...
sub call_method {
    ...
    my $ctx = SEEDServerContext->new($self->{loggers}->{userlog},
    ...
    # Service SEED does not require authentication.
	...
	my $stderr = SEEDServerStderrWrapper->new($ctx, $get_time);
	$ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service SEED.");
    }
...
package SEEDServerStderrWrapper;
