...
=head1 Co-occurrence Server Helper Object

=head2 Description

This module is used to call the Co-Occurrence Server, which is a special-purpose
server for manipulating functional coupling data from the Sapling database. Each
Co-Occurrence Server function corresponds to a method of this object.
...
sub new {
    ...
    my ($class, %options) = @_;
    # Compute the URL.
    $options{url} = 'http://servers.nmpdr.org/co_occurrence/server.cgi' if ! $options{url};
    # Construct the subclass.
    return $class->SUPER::new(CO => %options);
}
